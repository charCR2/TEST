<template>
  <Row class="pages">
    <Col span="4" class="height">
  <Menu :theme="theme3" active-name="1" width="auto" class="height" >
    <Submenu name="1">
      <template slot="title">
    ...
    <MenuGroup title="第一卷">
      <MenuItem name="1">
        <span style="padding-left: 10px;font-size: 13px">第一章</span>
      </MenuItem>
      <MenuItem name="2">
        <span style="padding-left: 10px;font-size: 13px">第二章</span>
      </MenuItem>
    </MenuGroup>
    </Submenu>
  </Menu>
